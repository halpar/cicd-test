...
public static class UsefulFunctions
{
	...
	public static string GetMoneyText(double money)
	{
		...
		{
			return money.ToString("0,,,.###B", CultureInfo.InvariantCulture);
		}
		else if (money > 999999 || money < -999999)
		{
			return money.ToString("0,,.##M", CultureInfo.InvariantCulture);
		}
		else if (money > 999 || money < -999)
		{
			return money.ToString("0,.#K", CultureInfo.InvariantCulture);
		}
		else
		{
