Shader "UI/Gradient"
{
    Properties
    {
        ...
        [HDR]_TopLeftColor("Gradient Top Left", Color) = (1,1,1,1)
        [HDR]_TopRightColor("Gradient Top Right", Color) = (1,1,1,1)
        [HDR]_BottomLeftColor("Gradient Bottom Left", Color) = (1,1,1,1)
        [HDR]_BottomRightColor("Gradient Bottom Right", Color) = (1,1,1,1)
